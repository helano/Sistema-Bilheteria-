...
<html>
    ...
    <main class="principal-table">
                ...
                <div class="container">
                    <h1> Tabela de Jogos </h1>
                        ...
                        <table border = 1 class="table table-condensed" Style="margin:20px;" >
                            <tr> <th> Nome </th> <th> Capacidade</th>  <th> Opções  </th>  </tr>
                <%
                    String[]   codigo = new String[100];
                    String[]   nome = new String[100];
                    String []  capacidade = new String[100];
                    ...
                    try{
                        ...
                        rs = st.executeQuery("SELECT  id_estadio, nome_est, capacidade FROM estadio;");
                        
                        for (int i= 0; rs.next(); i++){
                       // while (rs.next()){
                            
                       // out.println(rs.getString("cod_produto")+" - ");
                         codigo[i] = rs.getString("id_estadio");
                         nome[i] = rs.getString("nome_est");
                         //out.println(rs.getString("desc_produto")+" - ");
                           
                           capacidade[i] = rs.getString("capacidade");
                    ...
                    <tr class="<%=nome%>"> <td> <%=nome[i]%> </td> <td > <%=capacidade[i] %> </td>  <td > <a href="editarestadio.jsp?codigo=<%=codigo[i]%>" class="btn btn-primary" >Editar</a> <a href="verificaexcluirestadio.jsp?codigo=<%=codigo[i]%>" class="btn btn-danger" >Excluir</a> </td> </tr>
        ...
        <table  style="margin-left: 400px;"> 
            <tr> <td><a class="btn btn-primary" href="inserirestadio.jsp">Inserir novo Estadio </a> </td> <td> <a class="btn btn-primary" href="paineladmin.jsp">Voltar Para o Painel </a></td>
